...
const double p_worker2_t1l4_ORIGINAL=0.7;
const double p_worker2_t3l4_ORIGINAL=0.79;
const double p_worker2_t1l7_ORIGINAL=1.0;
const double p_worker2_t3l7_ORIGINAL=0.99;
const double p_worker2_t3l9_ORIGINAL=0.89;
const double p_worker2_t1l6b_ORIGINAL=0.8;
const double p_worker2_t1l6a_ORIGINAL=1.0;
const double p_r1_t2l5_ORIGINAL=0.99;
const double p_r1_t2l8a_ORIGINAL=0.95;
const double p_r1_t2l8b_ORIGINAL=0.8599;

const double e = 2.718281828459045;
const double steepnessw1 = 3;
const double steepnessr1 = 0.1;
formula p_worker2_t1l4 = 2 * (1 - p_worker2_t1l4_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t1l4 * steepnessw1)))) + (2 * p_worker2_t1l4_ORIGINAL - 1);
formula p_worker2_t3l4 = 2 * (1 - p_worker2_t3l4_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t3l4 * steepnessw1)))) + (2 * p_worker2_t3l4_ORIGINAL -1);
formula p_worker2_t1l7 = 2 * (1 - p_worker2_t1l7_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t1l7 * steepnessw1)))) + (2 * p_worker2_t1l7_ORIGINAL -1);
formula p_worker2_t3l7 = 2 * (1 - p_worker2_t3l7_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t3l7 * steepnessw1)))) + (2 * p_worker2_t3l7_ORIGINAL -1);
formula p_worker2_t3l9 = 2 * (1 - p_worker2_t3l9_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t3l9 * steepnessw1)))) + (2 * p_worker2_t3l9_ORIGINAL -1);
formula p_worker2_t1l6b = 2 * (1 - p_worker2_t1l6b_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t1l6b * steepnessw1)))) + (2 * p_worker2_t1l6b_ORIGINAL -1);
formula p_worker2_t1l6a = 2 * (1 - p_worker2_t1l6a_ORIGINAL) * (1 / (1 + 1/pow(e,(worker2retry_t1l6a * steepnessw1)))) + (2 * p_worker2_t1l6a_ORIGINAL -1);
