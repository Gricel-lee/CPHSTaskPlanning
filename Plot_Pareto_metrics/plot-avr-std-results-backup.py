...
def plot_metric(summary_df: pd.DataFrame, metric: str, y_label: str, output_filename: str):
    ...
    plt.savefig(os.path.join(output_dir, "legend.png"), dpi=300)
    plt.close()
...
if __name__ == "__main__":
    ...
    #>>>> Pass arguments here for testing
    sys.argv = ['process_summarize_plot.py', 'outputAgri_ChangeInjectedProp', 'plot_outputAgri_ChangeInjectedProp']
    sys.argv = ['process_summarize_plot.py', 'outputAgri_ChangeInjectedModel', 'plot_outputAgri_ChangeInjectedModel']
    sys.argv = ['process_summarize_plot.py', 'outputAgri_ChangeInjectedBoth', 'plot_outputAgri_ChangeInjectedBoth']

    sys.argv = ['process_summarize_plot.py', 'outputExpAgri_ChangeInjectedBoth', 'plot_outputExpAgri_ChangeInjectedBoth']
    sys.argv = ['process_summarize_plot.py', 'outputExpAgri_ChangeInjectedProp', 'plot_outputExpAgri_ChangeInjectedProp']
    # sys.argv = ['process_summarize_plot.py', 'outputExpAgri_ChangeInjectedBoth', 'plot_outputExpAgri_ChangeInjectedBoth']
